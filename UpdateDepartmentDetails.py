...
dbcursor.execute("select * from department_details where dept_code='"+dept_code+"'")
...
form='''
      ...
      <form action="UpdateDepartmentDetails_Backend.py">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Update Deaprtment Details</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Code" name="dept_code" value='''+result[0]+'''>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Department Name"  name="dept_name" value='''+result[1]+'''>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="email" class="form-control" placeholder="Enter Official Email" name="dept_email" value='''+result[2]+'''>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Enter Official Number" name="dept_no" value='''+result[3]+'''>
                        <div class="input-group-append">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"
                          placeholder="Enter Opening Date" name="dept_opening_date" value='''+result[4]+'''/>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group is-warning">
                      ...
                      <input type="text" class="form-control" placeholder="Enter First Name" name="dept_hd_fname" value='''+result[5]+'''>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Department Head Last Name</label>
                      <input type="text" class="form-control" placeholder="Enter Last Name" name="dept_hd_lname" value='''+result[6]+'''>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group is-warning">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Enter Email" name="dept_hd_email" value='''+result[7]+'''>
                        <div class="input-group-append">
                          <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                        </div>
                      </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Enter Number" name="dept_hd_no" value='''+result[8]+'''>
                        <div class="input-group-append">
                          <span class="input-group-text"><i class="fas fa-phone"></i></span>
                        </div>
                      </div>
          ...
          <div class="col-sm-12">
            <div class="form-group">
              <button type="submit" class="btn btn-primary col-sm-12">Update Department Details</button>
            </div>
          </div>
        </div>
        </form>
...
config.useHeader("Update Department Details",cssfiles)
print(form)
