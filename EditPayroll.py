...
config.useHeader("Update Payroll",cssfiles)

for x in results:
  print(''' 
        <div class="content-wrapper">
        <form action="EditPayroll_Backend.py" method="post">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Name</label>
                          <input type="text" class="form-control" placeholder="Enter Employee Name" name="fname" value="'''+str(x[1])+'''" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Designation" name="designation" value="'''+str(x[3])+'''" readonly>
                        </div>
                      </div>
                    </div>                    
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Department" name="department" value="'''+str(x[4])+'''" readonly>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <!-- text input -->
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Primary Mobile No" name="pmobileno" value="'''+str(x[5])+'''" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Employee type" name="typeemployment" value="'''+str(x[6])+'''" readonly>
                        </div>
                      </div> 
                      <div class="col-sm-6">
                        <!-- text input -->
                        <div class="form-group">
                          <label>Email  </label>
                          <input type="text" class="form-control" placeholder="Enter email" name="email" value="'''+str(x[7])+'''" readonly>
                        </div>
                      </div>                    
                    </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter gross salary For Year" name="gross_salary" value="'''+str(x[8])+'''">
                        </div>
                      </div>                      
                    </div>
