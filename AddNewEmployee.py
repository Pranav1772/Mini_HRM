...
dbcursor.execute("select dept_code,dept_name from department_details")
results=dbcursor.fetchall()
config.useHeader("Add New Department",cssfiles)

config.useHeader("Add New Employee",cssfiles)
print('''    <div class="content-wrapper">
      <form name="form" enctype = "multipart/form-data" action="AddNewEmployee_backend.py" method="post">
      ...
      <!-- Main content -->
      <form action="AddNewEmployee_backend.py" method="post">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      <label>FATHER NAME</label>
                        <input type="text" class="form-control" name="faname" placeholder="Enter Father Name">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="moname" placeholder="Enter Mother Name"> 
                    </div>
                  </div>
                <div class="col-sm-6">
                    <div class="form-group">
                      <label>BIRTH DATE</label>
                        <div class="input-group date" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate"
                            placeholder="00/00/0000"  name="birthdate"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="spname" placeholder="Enter Spouse Name">                   
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" placeholder="Enter Area and Street" name="addressarea" ></textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="pmobileno" placeholder="Enter primary Mobile No">                    
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <!-- text input -->
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="smobileno" placeholder="Enter Secondary Mobile No">
                </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group is-warning">
                      ...
                      <input type="text" class="form-control" placeholder="Enter First Name" name="bankname">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Bank Branch Name</label>
                      <input type="text" class="form-control" placeholder="Enter Last Name" name="bankbranchname">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Enter Account No." name="bankaccount">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="una" placeholder="Enter UAN  No">
                    </div>
                  </div>
                </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="education" placeholder="Enter Education Till"> 
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="markofiden" placeholder="Enter Mark Of Identification"> 
                    </div>
                  </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group is-warning">
                      ...
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input"
                          data-target="#reservationdate" placeholder="00/00/0000" name="inputdata" />
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>END DATE WORKING</label>
                          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input"
                              data-target="#reservationdate" placeholder="00/00/0000" name="enddate" />
                            <div class="input-group-append" data-target="#reservationdate"
                              data-toggle="datetimepicker">
                              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input"  id="emp_photo" name="emp_photo">
