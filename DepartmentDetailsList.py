...
dbcursor.execute("select * from department_details;")
...
config.useHeader("Department Details List",cssfiles)
print('''
              ...
              <div class="card-body table-responsive p-0" style="height: 465px;">
                <table class="table table-head-fixed table-hover text-nowrap">
                  ...
                  <tr>
                    ...
                    <th>Department Official Email</th>
                    <th>Department Official number</th>
                    <th>Department Opening Date</th>
                    <th>Department Head First Name</th>
                    <th>Department Head Second Name</th>
                    <th>Department Head Email</th>                    
                    <th>Department Head No.</th>                    
                  </tr>
                  </thead>''')
for x in result:
  print('''       <tbody>
                  <tr>
                    <td>                      
                      <div class="row">                          
                        <div class="col-12">
                          <a href="UpdateDepartmentDetails.py?dept_code='''+x[0]+'''">
                              
                            <button type="submit" class="btn btn-outline-warning btn-block btn-sm">Edit</button>
                          </a> 
                          <br>
                          <a href="DeleteDepartmentDetails_Backend.py?dept_code='''+x[0]+'''"> 
