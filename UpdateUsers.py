...
dbcursor.execute("select * from users_master where id ='"+str(id)+"';")
x=dbcursor.fetchone()
...
print(''' 
        ...
        <form action="UpdateUsers_Backend.py" method="post">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter employee id" name="id" value="'''+str(x[2])+'''" readonly>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <!-- text input -->
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Employee Name" name="name" value="'''+str(x[3])+'''" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            <input type="email" class="form-control" placeholder="Enter Username" name="email" value="'''+str(x[0])+'''" readonly>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Enter password" name="password" value='''+str(x[1])+'''>
                            <div class="input-group-append">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2bs4" 
                            ...
                            <option selected="selected" value='''+ ("1" if str(x[5]) ==1 else "0")+'''>'''+("Active" if str(x[5]) == '1' else "Disabled")+'''</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select class="form-control select2bs4" 
                            ...
                            <option selected="selected" value='''+str(x[4])+'''>'''+str(x[4])+'''</option>
