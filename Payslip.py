...
config.useHeader("Payslip",cssfiles)
        ...
        <form action="AddPayroll_Backend.py" method="post">
          ...
          <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-12">
                  <a href="payslip_print.py?id='''+str(x[0])+'''" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                </div>  <a href="Payslip.py?id='''+str(x[0])+'''">
              </div>
