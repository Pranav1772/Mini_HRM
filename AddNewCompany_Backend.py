...
dbcursor.execute("insert into company_details values('"+cmp_reg_id+"','"+cmp_name+"','"+cmp_email+"','"+cmp_no+"','"+cmp_reg_date+"',LOAD_FILE('"+cmp_logo+"'),'"+cmp_gst_no+"',"+cmp_type+",'"+cmp_bnk_name+"','"+cmp_bnk_brn_name+"','"+cmp_bnk_ifsc_code+"','"+cmp_bnk_acc_no+"','"+cmp_addr+"','"+cmp_locality+"','"+cmp_pincode+"',"+cmp_district+","+cmp_state+",'"+cmp_own_fname+"','"+cmp_own_lname+"','"+cmp_own_email+"','"+cmp_own_no+"');")
conn.commit()
